...
print("Average Marks of S1 and S3",np.mean(a[:,1:4:2],axis=0))

# 13. print Roll number who got maximum marks in Subject 3
c = np.argmax(a[:,3])
print("Roll no who got maximum marks in Subject 3",a[c,0])

# 14. print Roll number who got minimum marks in Subject 2
d = np.argmin(a[:,2])
print("Roll no who got minimum marks in Subject 2",  a[d,0]  )

# 15. print Roll number who got 24 marks in Subject 2
e = np.where(a[:,2]==24)
print("Roll no who got 24 marks in Subject 2",  a[e,0])

# 16. print count of students who got marks in Subject 1 < 40
count = np.sum(a[:,1]<40)
print("Count of students who got marks in Subject 1 < 40",count)

# 17. print count of students who got marks in Subject 2 > 90
count = np.sum(a[:,2]>90)
print("Count of students who got marks in Subject 2 > 90:",   count           )

# 18. print count of students in each subject who got marks >= 90
count = np.sum(a[:,1:4]>=90,axis=0)
